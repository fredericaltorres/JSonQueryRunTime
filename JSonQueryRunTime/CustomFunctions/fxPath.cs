    ...
    class fxPath: Function
    {
        ...
        public Literal ExecuteWithUnknown(IConstruct[] arguments)
        {
            ...
            try
            {
                ...
                //decimal expectedNumberValue;
                //string expectedStringValue;
                //bool expectedBooleanValue;
                //DateTime expectedDateTimeValue;
                //string expectedNullValue;

                //if(jsonExpectedType == JTokenType.Float) expectedNumberValue = base.GetTransformedArgument<Number>(arguments, argumentIndex: 1);
                //if(jsonExpectedType == JTokenType.String) expectedStringValue = base.GetTransformedArgument<Text>(arguments, argumentIndex: 1);
                //if(jsonExpectedType == JTokenType.Boolean) expectedBooleanValue = base.GetTransformedArgument<Boolean>(arguments, argumentIndex: 1);
                //if(jsonExpectedType == JTokenType.Date) expectedDateTimeValue = base.GetTransformedArgument<DateTime>(arguments, argumentIndex: 1);
                //if(jsonExpectedType == JTokenType.Null) expectedNullValue = base.GetTransformedArgument<Null>(arguments, argumentIndex: 1);
                ...
                {
                    JToken lastValue = EvalPath(possiblePath);
